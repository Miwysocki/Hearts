...
public class Main {
	...
	JFrame window;
	Container con;
	JPanel playPanel,humanPanel,c1Panel, c2Panel, c3Panel, centralPanel;
	static JTextArea humanArea;
	static JTextArea humanArea2;
	static JLabel label;
	static JTextArea humanPlayed,c1Area, c2Area, c3Area;

	static JButton[] buttons = new JButton[13];
	static JLabel humanLabel,c1Label, c2Label, c3Label;
	static JButton ok,newGame,loadGame;
	...
	static void initPlayers() {
		 ...
		 human.playerLabel = humanLabel;
		 c1 = new Player("c1");
		 c1.playerArea = c1Area;
		 c1.playerLabel = c1Label;
		 c2 = new Player("c2");
		 c2.playerArea = c2Area;
		 c2.playerLabel = c2Label;
		 c3 = new Player("c3");
		 c3.playerArea = c3Area;
		 c3.playerLabel = c3Label;
	...
	static void  exchange() throws IOException {
		if(round != 4) {
	 ...
	 static void showHumanCards() throws IOException
	{

		 for (int i = 0; i < human.cardsOnHand ; i++) {
			 buttons[i].setIcon(human.hand.get(i).getIcon());
		}
	...
	public Main() throws IOException {
		...
		playPanel.setBounds(0,50, 250, 1000);
		...
		centralPanel.setBounds(500,450, 500, 500);
		...
		humanLabel.setBounds(200, 50, 50, 800);
		humanPanel.add(humanLabel);
		
		c1Label = new JLabel();
		c1Label.setBounds(200, 50, 50, 800);
		c1Panel.add(c1Label);
		
		c2Label = new JLabel();
		c2Label.setBounds(200, 50, 50, 800);
		c2Panel.add(c2Label);
		
		c3Label = new JLabel();
		c3Label.setBounds(200, 50, 50, 800);
		c3Panel.add(c3Label);
		...
		//buttons
		 ok = new JButton("Ok");
		ok.setBounds(50,50,40,40);
		ok.addActionListener(new Action(99));
		ok.setVisible(false);
		centralPanel.add(ok);
		
		 loadGame = new JButton("Load Game");
		 loadGame.setBounds(50,50,40,40);
		 loadGame.addActionListener(new Action(101));
		 loadGame.setVisible(false);
		centralPanel.add(loadGame);
		
		 newGame = new JButton("New Game");
		 newGame.setBounds(50,50,40,40);
		 newGame.addActionListener(new Action(100));
		 newGame.setVisible(false);
		centralPanel.add(newGame);
		...
		for(int i =0; i<13; i++)
		{
			...
			jb.setBounds(x, y, 57, 88);			
			
			jb.setBorderPainted(false);
			//jb.setFocusPainted(false);
			jb.setContentAreaFilled(false);
			jb.addActionListener(new Action(i));
	...
	private static void play() throws IOException {
		...
		for (Player p : playerList) {
			if(p == begins) {
				...
				begins.playerLabel.setIcon(begins.playedCard.getIcon());
			...
			else 
			{
				...
				p.playerLabel.setIcon(p.playedCard.getIcon());
			}
		}
		...
		human.playerLabel.setIcon(null);
		c1.playerLabel.setIcon(null);
		c2.playerLabel.setIcon(null);
		c3.playerLabel.setIcon(null);
	...
	static Card chooseCard(String startColor) 
	{
		...
		human.cardsOnHand--;
		buttons[human.cardsOnHand].setVisible(false);;
		entered = false;
	  ...
	  static  void readJson() throws Exception 
	   ...
	   static class Action implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(index == 101) {//load game
				load = 1;
				space = true;
			}
			
			if(index == 100) {//new game
				space = true;
			}
